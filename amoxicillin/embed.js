// HEAL Amoxicillin dose calculator - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="amoxicillin"></div>
//   <script src="https://<user>.github.io/<repo>/amoxicillin/embed.js"></script>
//
...
(function () {
  ...
  function mount(target) {
    ...
    link.rel = "stylesheet";
    link.href = new URL("amoxicillin/amoxicillin.css", base).href;
    var container = document.createElement("div");
    root.appendChild(link);
    root.appendChild(container);
    window.healRenderAmoxicillin(container);
  }

  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="amoxicillin"]');
