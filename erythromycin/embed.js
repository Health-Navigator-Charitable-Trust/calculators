// HEAL Erythromycin Dose Calculator - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="erythromycin"></div>
//   <script src="https://<user>.github.io/<repo>/erythromycin/embed.js"></script>
//
...
(function () {
  ...
  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="erythromycin"]');
    ...
    Promise.all([
      ...
      loadScript(new URL("erythromycin/erythromycin.js", base).href),
    ])
      .then(function () {
      ...
      .then(function () {
        ...
        window.healAnalytics.init("erythromycin", !verdict.allowed);
