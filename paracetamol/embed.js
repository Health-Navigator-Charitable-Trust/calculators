// HEAL Paracetamol dose calculator - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="paracetamol"></div>
//   <script src="https://<user>.github.io/<repo>/paracetamol/embed.js"></script>
//
...
(function () {
  ...
  function mount(target) {
    ...
    link.rel = "stylesheet";
    link.href = new URL("paracetamol/paracetamol.css", base).href;
    var container = document.createElement("div");
    root.appendChild(link);
    root.appendChild(container);
    window.healRenderParacetamol(container);
  }

  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="paracetamol"]');
    if (!targets.length) return;

    Promise.all([
      loadScript(new URL("allowed-domains.js", base).href),
      loadScript(new URL("shared/analytics.js", base).href),
      loadScript(new URL("paracetamol/paracetamol.js", base).href),
    ])
      .then(function () {
      ...
      .then(function () {
        ...
        window.healAnalytics.init("paracetamol", !verdict.allowed);
