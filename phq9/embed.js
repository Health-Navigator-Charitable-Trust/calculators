// HEAL PHQ-9 questionnaire - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="phq9"></div>
//   <script src="https://<user>.github.io/<repo>/phq9/embed.js"></script>
//
...
(function () {
  ...
  function mount(target) {
    ...
    link.rel = "stylesheet";
    link.href = new URL("phq9/phq9.css", base).href;
    var container = document.createElement("div");
    root.appendChild(link);
    root.appendChild(container);
    window.healRenderPHQ9(container);
  }

  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="phq9"]');
    if (!targets.length) return;

    Promise.all([
      loadScript(new URL("allowed-domains.js", base).href),
      loadScript(new URL("shared/analytics.js", base).href),
      loadScript(new URL("phq9/phq9.js", base).href),
    ])
      .then(function () {
      ...
      .then(function () {
        ...
        window.healAnalytics.init("phq9", !verdict.allowed);
