// HEAL Flucloxacillin Dose Calculator - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="flucloxacillin"></div>
//   <script src="https://<user>.github.io/<repo>/flucloxacillin/embed.js"></script>
//
...
(function () {
  ...
  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="flucloxacillin"]');
    ...
    Promise.all([
      ...
      loadScript(new URL("flucloxacillin/flucloxacillin.js", base).href),
    ])
      .then(function () {
      ...
      .then(function () {
        ...
        window.healAnalytics.init("flucloxacillin", !verdict.allowed);
