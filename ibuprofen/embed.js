// HEAL Ibuprofen Dose Calculator - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="ibuprofen"></div>
//   <script src="https://<user>.github.io/<repo>/ibuprofen/embed.js"></script>
//
...
(function () {
  ...
  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="ibuprofen"]');
    ...
    Promise.all([
      ...
      loadScript(new URL("ibuprofen/ibuprofen.js", base).href),
    ])
      .then(function () {
      ...
      .then(function () {
        ...
        window.healAnalytics.init("ibuprofen", !verdict.allowed);
