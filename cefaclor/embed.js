// HEAL Cefaclor Dose Calculator - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="cefaclor"></div>
//   <script src="https://<user>.github.io/<repo>/cefaclor/embed.js"></script>
//
...
(function () {
  ...
  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="cefaclor"]');
    ...
    Promise.all([
      ...
      loadScript(new URL("cefaclor/cefaclor.js", base).href),
    ])
      .then(function () {
      ...
      .then(function () {
        ...
        window.healAnalytics.init("cefaclor", !verdict.allowed);
