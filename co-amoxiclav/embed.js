// HEAL Co-amoxiclav Dose Calculator - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="co-amoxiclav"></div>
//   <script src="https://<user>.github.io/<repo>/co-amoxiclav/embed.js"></script>
//
...
(function () {
  ...
  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="co-amoxiclav"]');
    ...
    Promise.all([
      ...
      loadScript(new URL("co-amoxiclav/co-amoxiclav.js", base).href),
    ])
      .then(function () {
      ...
      .then(function () {
        ...
        window.healAnalytics.init("co-amoxiclav", !verdict.allowed);
