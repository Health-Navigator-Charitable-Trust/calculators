// HEAL Co-trimoxazole Dose Calculator - script-tag embed.
//
// Host page usage:
//   <div data-heal-calculator="co-trimoxazole"></div>
//   <script src="https://<user>.github.io/<repo>/co-trimoxazole/embed.js"></script>
//
...
(function () {
  ...
  function init() {
    var targets = document.querySelectorAll('[data-heal-calculator="co-trimoxazole"]');
    ...
    Promise.all([
      ...
      loadScript(new URL("co-trimoxazole/co-trimoxazole.js", base).href),
    ])
      .then(function () {
      ...
      .then(function () {
        ...
        window.healAnalytics.init("co-trimoxazole", !verdict.allowed);
